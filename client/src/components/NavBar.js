...
function NavBar({ currentUser }) {
    ...
    const navClass = "block py-2 pl-3 pr-4 text-white bg-blue-700  text-2xl font-bold rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500"
